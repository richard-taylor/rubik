...
#ifndef TETRACACHELAYER_H
#define TETRACACHELAYER_H
...
class TetraCacheLayer : public CacheLayer
{
public:
    /**
    Load a layer of a certain depth (number of moves from solved).
    */
    TetraCacheLayer(const std::string &basename, int deep);
